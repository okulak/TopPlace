...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    id program = [[FlickrFetcher topPlaces] objectAtIndex:indexPath.row];
    NSString *place = [NSString stringWithFormat:@"%@",[program valueForKey:@"woe_name"]];
    NSString *location = [NSString stringWithFormat:@"%@",[program valueForKey:@"_content"]];
